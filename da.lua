...
local Window = Library:Create("DaWare","Da Hood")
local Tab1 = Window:Tab("Aimlocks",true)
 
Tab1:Label("StatueLock")
 
Tab1:Button("DaLock",function(bool)
...
Tab1:Textbox("DaLock Keybind","Q",function(bool)
    getgenv().AimlockKey = bool
end)
 
Tab1:Textbox("DaLock Prediction","6",function(bool)
...
local Tab2 = Window:Tab("DaSilentAim",false)
